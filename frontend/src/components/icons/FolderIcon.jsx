export default function FolderIcon ({className}){
    return( 
        <svg className={className} xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
            <path d="M176.263-188.078q-28.353 0-48.269-19.916-19.916-19.916-19.916-48.3v-447.412q0-28.384 19.916-48.3 19.916-19.916 48.353-19.916h191.306q13.741 0 26.435 5.355 12.693 5.354 22.105 14.878l55.729 55.729h311.815q28.353 0 48.269 19.916 19.916 19.915 19.916 48.353v371.344q0 28.437-19.916 48.353t-48.269 19.916H176.263Z"/>
        </svg>
    )
